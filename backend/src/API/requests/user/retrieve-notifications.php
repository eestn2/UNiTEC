...
try {
    ...
    return_response_outdated("success", "Notificaciones recuperadas correctamente.", ["notifications" => $notifications]);
} catch (PDOException $e) {
    error_log("Error retrieving notifications: " . $e->getMessage());
    return_response_outdated("failed", "Error al recuperar las notificaciones.", null);
}
?>