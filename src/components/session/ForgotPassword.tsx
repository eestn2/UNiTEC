...
const ForgotPassword: React.FC = () => {
    ...
    return (
        <div>
            ...
            <AppWindow width={370} height={620} vertical={true} style={
                {display: "flex", 
                ...
                <form name="change-password" style={{display: "flex", flexDirection:"column", alignItems: "flex-start", rowGap: TranslateFigmaCoords.translateFigmaYAlt(18)}} method="post">
                    ...
                    <InputField name="code" type="text" vertical={true} placeholder="Ingrese el codigo de verificación" width={320} height={50}/>
                ...
                <ActionButton vertical={true} height={60} text={"Confirmar"} width={100}/>
            </AppWindow>
        </div>
    );
};
